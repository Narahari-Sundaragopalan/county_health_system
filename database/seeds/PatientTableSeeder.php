...
class PatientTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Patient::create([  'hospital_id' => 1, 'patient_first_name' => 'John', 'patient_last_name' => 'Smith',
            ...
            'gender' => 'Male', 'date_of_birth' => date('1987-03-12'), 'department' => 'Fire', 'next_of_kin' => 'xyz', 'next_of_kin_contact' => '(402)-500-0000',
        ...
        Patient::create([  'hospital_id' => 2, 'patient_first_name' => 'Adam', 'patient_last_name' => 'Hayden',
            ...
            'gender' => 'Male', 'date_of_birth' => date('1991-03-12'), 'department' => 'Fire', 'next_of_kin' => 'xyz', 'next_of_kin_contact' => '(402)-510-9800',
