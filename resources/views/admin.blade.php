                            ...
                            <div class="carousel-inner" style="text-align: center;">
                                <div class="item active" style="text-align: center;">
                                    <a href="{{ url('/emergencies') }}" target="_blank">
                                        <img src="/images/o-AMBULANCE.jpeg" class="img-responsive">
                                    </a>
                                    <div class="mid">
                                ...
                                <div class="item" style="text-align: center;">
                                    <a href="{{ url('/roles') }}" target="_blank">
                                        <img src="/images/manageusers.png" class="img-responsive">
                                    </a>
                                    <div class="mid">
                                        <h3>Manage User and Roles</h3>
                                    </div>
                                </div>
                            </div>
